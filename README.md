...
This repository contains the source files for the official documentation of battleWarden.

The rendered documentation is hosted on GitHub Pages and is accessible through this
URI: https://docs.battlewarden.net

## Contributing

Any contributions to the battleWarden documentation is highly appreciated. Please use the _fork and pull request_
pattern for this intention.
...
[^1]: Any Python distribution such as CPython, Anaconda or Miniforge is fine. However, we recommend
